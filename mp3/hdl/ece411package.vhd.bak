...
--CACHE SIGNALS (ADD MORE TO ME!!)
  SUBTYPE LC3B_C_OFFSET  IS STD_LOGIC_VECTOR(3 DOWNTO 1);
  ...
  SUBTYPE LC3B_IMM4     IS STD_LOGIC_VECTOR(3 DOWNTO 0);
	...
	TYPE OPNAME IS (add_op, and_op, not_op, pass_op, sll_op, srl_op, sra_op, bad_op, ldr_op, str_op, br_op, jmp_op, jsr_op, lea_op, trap_op, no_op);
