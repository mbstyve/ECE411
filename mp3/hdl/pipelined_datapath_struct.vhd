...
ARCHITECTURE struct OF Pipelined_Datapath IS
   ...
   SIGNAL flush_INV       : std_logic;
   SIGNAL flushclk        : STD_LOGIC;
   ...
   FOR ALL : delayforflush USE ENTITY ece411.delayforflush;
