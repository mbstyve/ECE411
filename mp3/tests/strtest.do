echo "--- Executing initialization force file for ../mp3/ECE411/mp3/tests/strtest.asm ---"
...
echo "Done initializing processor, loading ../mp3/ECE411/mp3/tests/strtest.asm program code."
run 5
change /mp3_cpu/TM/VHDL_MEMORY/mem(0) X"07"
change /mp3_cpu/TM/VHDL_MEMORY/mem(1) X"E2"
change /mp3_cpu/TM/VHDL_MEMORY/mem(2) X"41"
change /mp3_cpu/TM/VHDL_MEMORY/mem(3) X"64"
change /mp3_cpu/TM/VHDL_MEMORY/mem(4) X"0B"
change /mp3_cpu/TM/VHDL_MEMORY/mem(5) X"74"
...
run 5
echo "Done loading ../mp3/ECE411/mp3/tests/strtest.asm program code."
