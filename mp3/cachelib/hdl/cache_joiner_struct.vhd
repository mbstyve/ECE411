-- VHDL Entity cachelib.CACHE_JOINER.symbol
--
-- Created:
--          by - freed2.ews (gelib-057-11.ews.illinois.edu)
--          at - 21:05:33 04/17/14
--
...
--
-- VHDL Architecture cachelib.CACHE_JOINER.struct
--
-- Created:
--          by - freed2.ews (gelib-057-11.ews.illinois.edu)
--          at - 21:05:34 04/17/14
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2012.1 (Build 6)
--
LIBRARY ieee;
...
ARCHITECTURE struct OF CACHE_JOINER IS
   ...
   FOR ALL : ByteMux2 USE ENTITY cachelib.ByteMux2;
   FOR ALL : ByteSplitter USE ENTITY cachelib.ByteSplitter;
   FOR ALL : Decode8 USE ENTITY cachelib.Decode8;
   FOR ALL : InputSplitter USE ENTITY cachelib.InputSplitter;
   FOR ALL : OWORD_COMBINE USE ENTITY cachelib.OWORD_COMBINE;
   FOR ALL : TwoByteConc USE ENTITY cachelib.TwoByteConc;
