...
ARCHITECTURE struct OF Cache_Datapath IS
   ...
   FOR ALL : AND4Bit USE ENTITY ece411.AND4Bit;
   FOR ALL : CACHE_JOINER USE ENTITY ece411.CACHE_JOINER;
   FOR ALL : Compare9 USE ENTITY ece411.Compare9;
   FOR ALL : DataArray USE ENTITY ece411.DataArray;
   FOR ALL : MemStoreAddressCalc USE ENTITY ece411.MemStoreAddressCalc;
   FOR ALL : OR2 USE ENTITY ece411.OR2;
   FOR ALL : OWordMux2 USE ENTITY ece411.OWordMux2;
   FOR ALL : STD_ONE USE ENTITY ece411.STD_ONE;
   FOR ALL : SingleBitArray USE ENTITY ece411.SingleBitArray;
   FOR ALL : TagArray USE ENTITY ece411.TagArray;
   FOR ALL : WordMux2 USE ENTITY ece411.WordMux2;
   FOR ALL : WordMux2Sel2 USE ENTITY ece411.WordMux2Sel2;
...
BEGIN
   ...
   StoreAddrCalc : MemStoreAddressCalc
      PORT MAP (
         Way1ADDR     => Way1ADDR,
         Way0ADDR     => Way0ADDR,
         index        => index,
