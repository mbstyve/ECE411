-- VHDL Entity cachelib.Cache_Datapath.interface
--
-- Created:
...
--
-- VHDL Architecture cachelib.Cache_Datapath.struct
--
-- Created:
--          by - freed2.ews (gelib-057-16.ews.illinois.edu)
--          at - 14:52:36 03/31/14
...
ARCHITECTURE struct OF Cache_Datapath IS
   ...
   FOR ALL : ADDR_SPLIT USE ENTITY cachelib.ADDR_SPLIT;
   ...
   FOR ALL : MemStoreAddressCalc USE ENTITY cachelib.MemStoreAddressCalc;
   FOR ALL : OR2 USE ENTITY cachelib.OR2;
   FOR ALL : OWordMux2 USE ENTITY cachelib.OWordMux2;
   FOR ALL : STD_ONE USE ENTITY cachelib.STD_ONE;
